...
###### <клик>
Удвовльствие же от работы с таким проектом пропадет уже на введении второго скина. И так далее, с каждым скином оставляя все меньше человечного в разработчике, превращая его в копипаст-зомби.
...
###### <need to go deepper>
Он даже предоставляет скаффолдер для создания скаффолдеров. В терминах yo кастомны скаффолдер называется егнератором
...
Не бойтесь эксперементировать с соглашениями внутри команды с выбором файловой структурой, главное не пасуйте при появлении большого количества рутинных операций, а уничтожайте рутину всеми доступными способами.
