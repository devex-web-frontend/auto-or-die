...
Серебренной пули как организовывать ваш код - не существует. На вашу файловую структуру должны оказывать влияние идеология разработки и специфика ваших проектов.

В качестве исходных данных мы имели:
* класснеймы по БЭМу
* проекты для которых в любой момент моежт смениться цветовая схема или появится новая
