...
Различные фреймворки, накладывающие большое количество шаблонных операций, поставляются со своим скаффолдером. Это помогает следовать конвенциям, обеспечивающим работу фреймворка, и различным best practices позволяющим писать чистые и поддерживаемы приложения, практически на халяву.

### Скаффолдер

скаффолдер без привязки
